...
int main(int argc, char* argv[]) {
    ...
    Rm3100Deployment::TopologyState inputs;
    ...
    Rm3100Deployment::setupTopology(inputs);
    Rm3100Deployment::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    Rm3100Deployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
