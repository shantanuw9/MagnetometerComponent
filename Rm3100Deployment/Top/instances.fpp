module Rm3100Deployment {
  ...
  # --- NEW: Magnetometer Manager Instance ---
  instance magManager: Rm3100.MagnetometerManager base id 0x10005000 \
    queue size Default.QUEUE_SIZE \
    stack size Default.STACK_SIZE \
    priority 40

  # --- NEW: Linux I2C Driver Instance ---
  instance linuxI2cDriver: Drv.LinuxI2cDriver base id 0x10006000
